    ...
    <div class="row">
        <div class="card">
            <form class="form-horizontal p-2"
                ...
                @csrf()
                <h6 class="card-title my-4 text-success"><em class="fab fa-expeditedssl"></em>
                    {{ __('Joining Info') }}
                </h6>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label
                                    for="joining_date">{{ __("The default joining date for a student is set to the creation date of their profile. Please modify it if a different date is desired.") }}</label>
                                <div class="input-group mb-2">
                                    ...
                                    <input style="max-width: 120px" autocomplete="off"
                                        placeholder="{{ __('Date of Joining') }}" type="text" class="form-control"
                                        id="joining_date" name="joining_date"
                                        value="{{ isset($user->joining_date) ? $user->joining_date : old('joining_date') }}">
                                </div>
                ...
                <div class="card-body border-top p-9">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input maxlength="20" type="text" class="form-control" id="last_name" name="last_name"
                        ...
                        <div class="col-md-3 col-sm-12">
                            <div class="form-group">
                                ...
                                {{-- <input placeholder="{{ __('Blood Group') }}" type="text" class="form-control"
                        ...
                        <div class="col-md-2 col-sm-12">
                            <div class="form-group">
                                ...
                                <input maxlength="3" style="max-width:100px;" placeholder="{{ __('weight') }}" type="text"
                        ...
                        <div class="col-md-3 col-sm-12">
                            <div class="form-group row d-flex flex-column">
                                <label class="col-lg-3 col-sm-12 ">{{ __('Gender') }}</label>
                                <div class="col-md-9 d-flex flex-row justify-content-lg-between justify-content-sm-start">
                                    <div class="form-check ">
                                        <input type="radio" class="form-check-input" id="male" value="1"
                                            name="gender" required="" {{ old('gender') == 1 ? ' checked ' : '' }}
                                    ...
                                    <div class="form-check mx-3 ">
                                        <input type="radio" class="form-check-input" id="female" value="2"
                                            name="gender" required="" {{ old('gender') == 2 ? ' checked ' : '' }}
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <x-form.select2 label="" text_key="name" name="country_id" :value="isset($user) ? $user->country_id : old('country_id')"
                                    :options="countryList(@$user->country_id)" placeholder="{{ __('   -Choose- ') }}">
                                </x-form.select2>
                            </div>
                        </div>
                    </div>
                    ...
                    <hr />
                    <h6 class="card-title my-4 text-info"><em class="fas fa-paper-plane"></em>{{ __('Contact Details') }}
                    </h6>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-12">
                            ...
                            <div class="form-group">
                                <input maxlength="10" name="phone_number"
                                    value="{{ isset($user) ? $user->phone_number : old('phone_number') }}" type="tel"
                                    id="phone_number" class="form-control tel-input" placeholder="Phone Number">
                                <input type="hidden" name="phone_code" id="phone_code"
                                    value="{{ isset($user) ? $user->phone_code : (old('phone_code') != '' ? old('phone_code') : defaultCode()) }}"
                                    placeholder="Dialing Code" readonly>
                            </div>
                        </div>
                        ...
                        <div class="col-md-2 col-sm-12">
                            <div class="form-group">
                                <label for="emergency_contact">{{ __('Emergency Contact1') }}</label>
                                <input maxlength="14" type="text" class="form-control" id="emergency_contact"
                        ...
                        <div class="col-md-2 col-sm-12">
                            <div class="form-group">
                                <label for="emergency_contact_2">{{ __('Emergency Contact2') }}</label>
                                <input maxlength="14" type="text" class="form-control" id="emergency_contact_2"
                        ...
                        <div class="col-md-2 col-sm-12">
                            <div class="form-group">
                                ...
                                <input maxlength="6" type="text" class="form-control" id="po_box" name="po_box"
                    ...
                    <h6 class="card-title my-4 text-info"><em class="fas fa-sitemap"></em> {{ __('More Info') }}</h6>
                                ...
                                <div class="col-md-12 d-flex  ">
                                    ...
                                    <div class="form-check mx-2">
                                        <input value="1" type="radio" class="form-check-input"
                                            ...
                                            {{ isset($student->relative_enrolled) && $student->relative_enrolled == '1' ? 'checked' : '' }}>
                                        <label class="form-check-label mb-0"
                                            for="customControlValidation1">{{ __('Yes') }}</label>
                                    </div>
                                    <div class="form-check">
                                        <input value="0" type="radio" class="form-check-input"
                                            id="customControlValidation2" name="relative_enrolled" required=""
                    ...
                    <div class="row mt-3  ml-3">
                        ...
                        <div class="col-md-4" id="mart_style">
                            <div class="form-group">
                                ...
                                <input maxlength="30" placeholder="{{ __('Martial Art Style') }}" type="text"
                                    class="form-control" id="pre_martial_style" name="pre_martial_style"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-12">
                            <label for="passport_number">{{ __('Passport Number') }}/هاتف</label>
                            <div class="form-group">
                                <input  maxlength="13" name="passport_number"
                                    value="{{ isset($student) ? $student->passport_number :  old('passport_number') }}" type="text"
                        ...
                        <div class="col-md-3 col-sm-12">
                            ...
                            <div class="form-group">
                                <input maxlength="15" name="passport_expiry"
                                    value="{{ isset($student) ? $student->passport_expiry : old('passport_expiry') }}" type="text"
                        ...
                        <div class="col-md-3 col-sm-12">
                            ...
                            <div class="form-group">
                                <input  maxlength="15" name="emirates_id"
                                    value="{{ isset($student) ? $student->emirates_id :  old('emirates_id') }}" type="text"
                        ...
                        <div class="col-md-3 col-sm-12">
                            ...
                            <div class="form-group">
                                <input maxlength="15" name="emirates_id_expiry"
                                    value="{{ isset($student) ? $student->emirates_id_expiry : old('emirates_id_expiry') }}" type="text"

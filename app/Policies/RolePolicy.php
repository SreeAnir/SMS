...
class RolePolicy
{
    ...
    {
        return $user->can(Role::PERMISSION_LIST);
    }
    ...
    {
        return $user->can(Role::PERMISSION_VIEW);
    }
    ...
    {
        return $user->can(Role::PERMISSION_CREATE);
    }
    ...
    {
        return   ($user->can(Role::PERMISSION_UPDATE) || $user->is($model));
    }
    ...
    {
        return !$model->hasRole(Role::ROLE_SUPER_ADMIN) && $user->can(Role::PERMISSION_DELETE);
    }
    ...
    {
        return $user->can(Role::PERMISSION_ASSIGN_ROLE);
    }
